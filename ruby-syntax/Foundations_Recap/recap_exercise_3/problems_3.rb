...
# the sequence, we add up the previous two numbers. For example, the first six numbers 
# of the sequence are: 2, 1, 3, 4, 7, 11, ...

# Write a method lucasSequence that accepts a number representing a length as an arg. 
# The method should return an array containing the Lucas Sequence up to the given 
# length. Solve this recursively.
